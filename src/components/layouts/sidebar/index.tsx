            ...
            <div className="space-y-4 py-4">
                <div className="px-3 py-2">
                    ...
                    <div className="space-y-3">
                        <div
                            className="inline-flex items-center px-4 py-2 gap-4 cursor-pointer hover:text-primary hover:bg-primary/5 w-full">
            ...
            <div className="space-y-4 py-4">
                <div className="px-3 py-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <div
                            className="inline-flex items-center px-4 py-2 gap-4 cursor-pointer text-red-500 hover:bg-red-100 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" className="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
